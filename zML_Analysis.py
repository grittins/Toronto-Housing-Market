...
#cpi_trim=5.2% august
#mortgage_rates 6.14% sept 30
# horizon=pd.period_range('2022-01-01','2023-9-30',freq='q')
# horizon.name='_date'
# fh_new=ForecastingHorizon(horizon,is_relative=False)
#vals=[[4,4,5,6,7,6,5,4],[4,4,4,4,4,4,4,4],[0,0,0,0,0,0,0,0]]
#arrays=[[community_filter]*len(horizon),[building_filter]*len(horizon),horizon]
#X_new=pd.DataFrame(data=np.array(vals).transpose(),index=pd.MultiIndex.from_arrays(arrays),columns=X_test.columns)
